...
insert into section (course_id, name, code) values (1, 'AB', '3L');
insert into section (course_id, name, code) values (1, 'AB', '4L');
insert into section (course_id, name, code) values (1, 'AB', '5L');
insert into section (course_id, name, code) values (1, 'AB', '6L');
insert into section (course_id, name, code) values (1, 'AB', '7L');
