...
insert into course (code, title, description, user_id) values ('CMSC 128', 'Introduction to Software Engineering', '*insert desc here*', 8);
insert into course (code, title, description, user_id) values ('CMSC 132', 'Computer Architecture', '*insert desc here*', 8);
insert into course (code, title, description, user_id) values ('CMSC 141', 'Automata and Language Theory', '*insert desc here*', 8);
insert into course (code, title, description, user_id) values ('CMSC 170', 'Introduction to Artifial Intelligence', '*insert desc here*', 8);
